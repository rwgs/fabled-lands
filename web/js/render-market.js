...
//
// DOM-construction methods for markets, inline buy/sell, rest, money/item caches,
// transfers and resurrection deals. Exported as a methods object that render.js mixes
// onto Story.prototype (Object.assign), so `this` is the Story instance and these compose
// with the rest of the renderer unchanged. The economy RULES live in market.js / engine.js;
// this only builds the widgets and wires the clicks.
